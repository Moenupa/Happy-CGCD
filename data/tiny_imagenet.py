...
def get_tiny_imagenet_datasets(
    ...
    whole_training_set = TinyImageNet(
        root=tiny_imagenet_root,
        split="train",
    ...
    each_old_unlabeled_samples = [
        ...
        for i, samples in enumerate(each_old_all_samples)
    ]  # for online old classes unlabeled
    ...
    test_dataset = TinyImageNet(
        root=tiny_imagenet_root, split="val", transform=test_transform, download=False
    )
    ...
    # NOTE!!!
    novel_cls_labels = [
        t for i, (p, t) in enumerate(novel_dataset_unlabelled.data)
    ]  # NOTE!!!
