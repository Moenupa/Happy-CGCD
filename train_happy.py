...
def train_online(
    ...
    for epoch in range(args.epochs_online_per_session):
        ...
        for batch_idx, batch in enumerate(train_loader):
            ...
            avg_probs_old_marginal, avg_probs_new_marginal = torch.sum(
                avg_probs_old_in
...
if __name__ == "__main__":
    ...
    # ----------------------
        ...
        for session in range(start_session, args.continual_session_num):
            ...
            online_session_train_dataset_for_new_head_init.old_unlabelled_dataset.transform = (
                test_transform  # NOTE!!!
            )
            online_session_train_dataset_for_new_head_init.novel_unlabelled_dataset.transform = (
                test_transform  # NOTE!!!
            )
